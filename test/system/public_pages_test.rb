...
class PublicPagesTest < ApplicationSystemTestCase
  ...
  test 'ideas for troop activities' do
    ...
    assert_selector 'h1', text: "Troop Activity Ideas"
  ...
  test 'ideas for troop fundraising activities' do
    ...
    visit '/'
    within'#main-nav' do
      click_on "Fundraising Activity Ideas"
    end
    assert_selector 'h1', text: "Fundraising Activity Ideas"
    assert_selector 'article', count: 5
    visit '/'
    within'footer' do
      click_on "Fundraising Activity Ideas"
  ...
  test 'ideas for troop covid safe activities' do
    ...
    visit '/'
    within'#main-nav' do
      click_on "COVID Safe Troop Activity Ideas"
    end
    assert_selector 'h1', text: "COVID Safe Troop Activity Ideas"
    assert_selector 'article', count: 5
    visit '/'
    within'footer' do
      click_on "COVID Safe Troop Activity Ideas"
